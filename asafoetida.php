...
<body>
                ...
                <div class="header-top-wrapper">
                    <div class="header-top-left">
                        <div class="header-top-contact">
                            <ul>
                                <li class="mail-fix"><a href="mailto:1989GOPALAKRISHNAN06@gmail.com"><i
                    ...
                    <div class="header-top-right social-fix">
    ...
    <section class="breadcrumb-section">
        <div class="container breadcrumb-content">
            <h1 class="text-white">Asafoetida</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Asafoetida</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="container my-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4">
                <img src="img/Asafoetida.jpg" class="img-fluid rounded shadow" alt="Asafoetida">
            </div>
            ...
            <div class="col-md-6">
                <h2>Asafoetida</h2>
                <p class="text-muted">
                    Asafoetida is a popular spice used in Indian cooking for its strong aroma
                    and distinctive flavor. It aids digestion and enhances the taste of dals,
                    curries, and pickles.
                </p>

                <ul class="list-unstyled">
                    <li><strong>Type:</strong> Pure Asafoetida</li>
                    <li><strong>Form:</strong> Powder / Granules</li>
                    <li><strong>Color:</strong> Light Yellow / Brown</li>
                    <li><strong>Usage:</strong> Cooking, Spice, Pickles</li>
                    <li><strong>Packaging:</strong> 50g, 100g, 250g</li>
                </ul>

                <p>
                    Our Asafoetida is carefully sourced and packed to ensure purity, strong flavor,
                    and long shelf life for all culinary needs.
                </p>
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p class="copyright-text">© Copyright 2023 <a>Sivan Sakthi Enterprises</a> | All Rights Reserved
                            Managed By :- <a href="https://trade4export.com"></a></p>
                    </div>
                    <div class="col-md-6 align-self-center">
