...
<body>
    ...
    <section class="breadcrumb-section">
        <div class="container breadcrumb-content">
            <h1 class="text-white">BPT Rice</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">BPT Rice</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="container my-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 mb-4">
                <img src="img/BPT-rice.avif" class="img-fluid rounded shadow" alt="BPT Rice">
            </div>
            ...
            <div class="col-md-6">
                <h2>BPT Rice</h2>
                <p class="text-muted">
                    BPT Rice is a premium quality variety known for its excellent aroma,
                    taste, and soft texture. Ideal for daily meals, restaurants, and bulk supply.
                </p>

                <ul class="list-unstyled">
                    <li><strong>Type:</strong> BPT White Rice</li>
                ...
                <p>
                    Our BPT rice is sourced from trusted farms, processed hygienically,
